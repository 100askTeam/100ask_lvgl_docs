...
+--------------------------------------------------+-------+--------------+
| `扩展B <https://www.qq                           |42720字| 20000-2A6DF  |
| xiuzi.cn/zh/hanzi-unicode-bianma.php?zfj=kzb>`__ |       |              |
+--------------------------------------------------+-------+------------+
| `扩展C <https://www.qq                           | 4153字 | 2A700-2B738 |
| xiuzi.cn/zh/hanzi-unicode-bianma.php?zfj=kzc>`__ |       |              |
+--------------------------------------------------+-------+------------+
| `扩展D <https://www.qq                           | 222字 | 2          |
| xiuzi.cn/zh/hanzi-unicode-bianma.php?zfj=kzd>`__ |  | B740-2B81D |
+--------------------------------------------------+-------+------------+
| `扩展E <https://www.qq                           | 5762字| 2          |
| xiuzi.cn/zh/hanzi-unicode-bianma.php?zfj=kze>`__ |  | B820-2CEA1 |
+--------------------------------------------------+-------+------------+
| `扩展F <https://www.qq                           | 7473字| 2         |
| xiuzi.cn/zh/hanzi-unicode-bianma.php?zfj=kzf>`__ |  | CEB0-2EBE0 |
+--------------------------------------------------+-------+------------+
| `扩展G <https://www.qq                           | 4939字| 3          |
| xiuzi.cn/zh/hanzi-unicode-bianma.php?zfj=kzg>`__ |  | 0000-3134A |
+--------------------------------------------------+-------+------------+
| `康熙部首 <https://www.qqx                       | 214字  | 2F00-2FD5  |
| iuzi.cn/zh/hanzi-unicode-bianma.php?zfj=kxbs>`__ |  |            |
+--------------------------------------------------+-------+------------+
| `部首扩展 <https://www.qqx                       | 115字  | 2E80-2EF3  |
| iuzi.cn/zh/hanzi-unicode-bianma.php?zfj=bskz>`__ |  |            |
+--------------------------------------------------+-------+------------+
| `兼容汉字 <https://www.qqx                       | 477字  | F900-FAD9  |
| iuzi.cn/zh/hanzi-unicode-bianma.php?zfj=jrhz>`__ |  |            |
+--------------------------------------------------+-------+------------+
| `兼容扩展 <https://www.qqx                       | 542字  | 2          |
| iuzi.cn/zh/hanzi-unicode-bianma.php?zfj=jrkz>`__ |  | F800-2FA1D |
+--------------------------------------------------+-------+------------+
| `PUA(GBK)部件 <https://www.qqxi                  | 81字  | E815-E86F  |
| uzi.cn/zh/hanzi-unicode-bianma.php?zfj=puabj>`__ |  |            |
+--------------------------------------------------+-------+------------+
| `部件扩展 <https://www.qqx                       | 452字  | E400-E5E8  |
| iuzi.cn/zh/hanzi-unicode-bianma.php?zfj=bjkz>`__ |  |            |
+--------------------------------------------------+-------+------------+
| `PUA增补 <https://www.qqxi                       | 207字 | E600-E6CF  |
| uzi.cn/zh/hanzi-unicode-bianma.php?zfj=puazb>`__ |  |            |
+--------------------------------------------------+-------+------------+
| `汉字笔画 <https://www.qqx                       | 36字   | 31C0-31E3  |
| iuzi.cn/zh/hanzi-unicode-bianma.php?zfj=hzbh>`__ |  |            |
+--------------------------------------------------+-------+------------+
| `汉字结构 <https://www.qqx                       | 12字   | 2FF0-2FFB  |
| iuzi.cn/zh/hanzi-unicode-bianma.php?zfj=hzjg>`__ |  |            |
+--------------------------------------------------+-------+------------+
| `汉语注音 <https://www.qqx                       | 43字   | 3105-312F  |
| iuzi.cn/zh/hanzi-unicode-bianma.php?zfj=hyzy>`__ |  |            |
+--------------------------------------------------+-------+------------+
| `注音扩展 <https://www.qqx                       | 22字   | 31A0-31BA  |
| iuzi.cn/zh/hanzi-unicode-bianma.php?zfj=zykz>`__ |  |            |
+--------------------------------------------------+-------+------------+
| 〇                                               | 1字 | 3007       |
+--------------------------------------------------+-------+------------+
